...
import type { DiscordEventCommand, ExternalEventCommand, SernEventCommand } from '../handler/structures/events';
import { CommandType, PluginType } from '../handler/structures/enums';
